            ...
            <Col lg={6}>
              <div className={styles.AboutSec1}>
                ...
                <div className={styles.AboutSec1Text}>
                  ...
                  <h4>
                    A Visionary CEO and BAFTA-Nominated Film Makeup Artist of 25
                    years, he is used to dealing one-on-one with Hollywood
                    high-flyers. He aced a programming exam with 100% and DJs on
                    the Net .
                  </h4>
                </div>
              ...
              <div className={styles.AboutSec1}>
                ...
                <div className={styles.AboutSec1Text}>
                  ...
                  <h4>
                    ...
                    helping Aesthetic Surgeons, from Beverly Hills to Barcelona
                    and beyond.
                  </h4>
                </div>
